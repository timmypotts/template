...
function insertManager(data) {
    ...
    <div class="card" style="width: 18rem;">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Email: <a class="card-link">${data.email}</a> </a></li>
...
function insertEngineer(data) {
    ...
    <div class="card" style="width: 18rem;">
        <div class="card-body bg-primary">
            <h4 class="card-title text-light">${data.name}</h4>
            <h5 class="card-title text-light">Engineer</h5>
        </div>
        <ul class="list-group list-group-flush">
            <li class="list-group-item">ID: ${data.id} </li>
            <li class="list-group-item">Email: <a class="card-link">${data.email}</a></li>
            <li class="list-group-item">GitHub:<a class="card-link">${data.github}</a></li>
        </ul>
    </div>
</div>
`;
...
function insertIntern(data) {
    return `
    <div class="col-sm-4 d-flex pb-3">
    <div class="card" style="width: 18rem;">
        <div class="card-body bg-primary">
            <h4 class="card-title text-light">${data.name}</h4>
            <h5 class="card-title text-light">Intern</h5>
        </div>
        <ul class="list-group list-group-flush">
            <li class="list-group-item">ID: ${data.id} </li>
            <li class="list-group-item">Email: <a class="card-link">${data.email}</a></li>
